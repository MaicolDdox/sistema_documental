...
<head>
    ...
    <title>Contraseña restablecida — SIGESI</title>
    <style>
        ...
        .header { background-color: #f59e0b; padding: 32px 40px; text-align: center; }
        ...
        .credentials { background-color: #fffbeb; border: 1px solid #fcd34d; border-radius: 8px; padding: 20px 24px; margin: 24px 0; }
        ...
        .warning { background-color: #fef2f2; border: 1px solid #fca5a5; border-radius: 8px; padding: 14px 18px; margin: 24px 0; font-size: 13px; color: #991b1b; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p>Tu contraseña en el <strong>SIGESI</strong> ha sido restablecida por <strong>{{ $restablecidaPor }}</strong>. Tus nuevas credenciales son:</p>
        ...
        <div class="warning">
            <strong>⚠ Si no solicitaste este cambio</strong>, contacta inmediatamente al administrador de tu centro de formación, ya que alguien pudo haber modificado tu contraseña sin tu autorización.
        </div>

        <p>Por seguridad, te recomendamos cambiar esta contraseña desde <strong>Configuración → Contraseña</strong> al ingresar.</p>

...
@section('title', 'Co-investigadores SDI')
@section('header', '')
...
<nav class="text-sm text-slate-500 mb-2">
    ...
    <span class="text-slate-700 font-medium">Co-investigadores SDI</span>
</nav>

<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-xl font-bold text-slate-900">Co-investigadores SDI</h1>
        <p class="text-sm text-slate-500 mt-0.5">Usuarios con rol Co-investigador SDI de tu centro de formación.</p>
    </div>
    @can('usuarios.crear_co_investigador_sdi')
    <a href="{{ route('dir-sem.co-investigadores.create') }}" class="sgd-btn-primary inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium">
...
<form method="GET" action="{{ route('dir-sem.co-investigadores.index') }}" class="flex gap-2 max-w-md mb-6">
    ...
    <div class="overflow-x-auto">
        <table class="sgd-table text-sm whitespace-nowrap">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-4 py-12 text-center text-slate-500">Aún no has registrado co-investigadores SDI.</td>
                </tr>
                @endforelse
            </tbody>
        </table>

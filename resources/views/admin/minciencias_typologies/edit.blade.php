    ...
    <div class="bg-white rounded-xl border border-slate-200 max-w-xl overflow-hidden">
        ...
        <form method="POST" action="{{ route('admin.minciencias-typologies.update', $minciencias_typology) }}" class="p-5 space-y-4">
            ...
            <div>
                ...
                <textarea name="descripcion" id="descripcion" rows="2" class="w-full border border-slate-200 rounded-lg px-3.5 py-2.5 text-sm focus:border-[#39A900] focus:ring-2 focus:ring-[#39A900]/10">{{ old('descripcion', $minciencias_typology->descripcion) }}</textarea>

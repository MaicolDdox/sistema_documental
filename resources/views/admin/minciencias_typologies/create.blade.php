<x-app-layout>
    <x-slot name="header">Nueva Tipología Minciencias</x-slot>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-xl font-semibold text-slate-900">Nueva Tipología</h2>
            <p class="text-sm text-slate-500 mt-1">Crear tipología Minciencias.</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 max-w-xl overflow-hidden">
        ...
        <form method="POST" action="{{ route('admin.minciencias-typologies.store') }}" class="p-5 space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" required class="w-full border border-slate-200 rounded-lg px-3.5 py-2.5 text-sm focus:border-[#39A900] focus:ring-2 focus:ring-[#39A900]/10">

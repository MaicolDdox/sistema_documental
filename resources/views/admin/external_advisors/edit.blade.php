<x-app-layout>
    <x-slot name="header">Editar Asesor Externo</x-slot>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h2 class="text-xl font-semibold text-slate-900">Editar Asesor Externo</h2>
            <p class="text-sm text-slate-500 mt-1">{{ $externalAdvisor->nombre_completo }}</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden max-w-2xl">
        ...
        <div class="p-5">
            <form method="POST" action="{{ route('admin.external-advisors.update', $externalAdvisor) }}" class="space-y-5">
                @csrf
                @method('PUT')
                <div>
                    ...
                    <input type="text" name="nombre_completo" id="nombre_completo" value="{{ old('nombre_completo', $externalAdvisor->nombre_completo) }}" required
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $externalAdvisor->email) }}"
                ...
                <div>
                    ...
                    <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $externalAdvisor->telefono) }}"
                ...
                <div>
                    ...
                    <input type="text" name="institucion" id="institucion" value="{{ old('institucion', $externalAdvisor->institucion) }}"

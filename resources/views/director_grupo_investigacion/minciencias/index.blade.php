<x-app-layout>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 mt-1">Productos de los co-investigadores GDI de tu grupo de investigación.</p>
    </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('director-grupo-investigacion.minciencias.show', $p) }}" class="text-[#39A900] hover:underline text-xs font-medium">Ver / Revisar</a>
                        </td>
                    </tr>
                    @empty
                    <tr><td colspan="6" class="px-4 py-8 text-center text-slate-500 text-sm">No hay productos Minciencias en tu grupo de investigación.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>

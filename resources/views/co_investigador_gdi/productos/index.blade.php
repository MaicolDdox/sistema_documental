...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <p class="text-sm text-slate-500 mt-0.5">Productos vinculados a tu grupo de investigación.</p>
    </div>
    <a href="{{ route('co-investigador-gdi.productos.create') }}"
                ...
                <tr>
                    ...
                    <td class="px-5 py-3">
                        <div class="flex items-center gap-3">
                            <a href="{{ route('co-investigador-gdi.productos.show', $producto) }}"
                            ...
                            <form action="{{ route('co-investigador-gdi.productos.destroy', $producto) }}" method="POST" onsubmit="return confirm('¿Eliminar este producto Minciencias? Esta acción no se puede deshacer.');">
                                @csrf @method('DELETE')

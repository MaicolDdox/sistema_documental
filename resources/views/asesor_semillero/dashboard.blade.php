...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    {{-- Semilleros --}}
    <a href="{{ route('asesor.mis_semilleros.index') }}" class="block bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md hover:border-[#39A900]/50 transition-all group">
        <div class="flex items-center justify-between mb-3">
            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-[#39A900] transition-colors">Semilleros</p>
            <div class="w-9 h-9 rounded-lg flex items-center justify-center transition-colors" style="background:#f0fdf4">
        ...
        <p class="text-3xl font-outfit font-bold text-slate-900 group-hover:text-[#39A900] transition-colors">{{ $totalSemilleros }}</p>
        <p class="text-xs text-slate-400 mt-1">Asignados a ti</p>
    </a>

    {{-- Aprendices --}}
    <a href="{{ route('asesor.aprendices.index') }}" class="block bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md hover:border-blue-400/50 transition-all group">
        <div class="flex items-center justify-between mb-3">
            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-blue-600 transition-colors">Aprendices</p>
    ...
    {{-- Proyectos --}}
    <a href="{{ route('asesor.proyectos.index') }}" class="block bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md hover:border-purple-400/50 transition-all group">
        <div class="flex items-center justify-between mb-3">
            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-purple-600 transition-colors">Proyectos</p>
        ...
        <p class="text-3xl font-outfit font-bold text-slate-900 group-hover:text-purple-600 transition-colors">{{ $totalProyectos }}</p>
        <p class="text-xs text-slate-400 mt-1">En tus semilleros</p>
    </a>

    {{-- Productos --}}
    <a href="{{ route('asesor.productos.index') }}" class="block bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md hover:border-amber-400/50 transition-all group">
        <div class="flex items-center justify-between mb-3">
            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wide group-hover:text-amber-600 transition-colors">Productos</p>

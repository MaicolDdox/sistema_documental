...
<div x-data="{ openExport: false }" class="flex flex-wrap items-center gap-3 mb-6">
    ...
    <form method="GET" class="flex gap-3">
        ...
        <button type="submit" class="px-4 py-2.5 bg-white border border-slate-200 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 transition-all flex-shrink-0">Filtrar</button>
        @if(request('buscar'))

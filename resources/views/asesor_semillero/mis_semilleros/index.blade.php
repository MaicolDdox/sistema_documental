...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between gap-4">
        <div>
            <h1 class="text-lg font-semibold text-slate-900">Mis semilleros</h1>
            <p class="text-sm text-slate-500 mt-1">
                Visualiza los semilleros donde eres asesor y los proyectos asociados a cada uno.
            </p>
        </div>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="flex-1 min-w-0">
                ...
                @if($sem->projects->isEmpty())
                    <div class="px-5 py-6 text-center text-sm text-slate-400 bg-slate-50/60">

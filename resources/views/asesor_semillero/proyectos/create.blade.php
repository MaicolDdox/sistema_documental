    ...
    <div class="bg-white rounded-xl border border-slate-200 p-6">
        <form method="POST" action="{{ route('asesor.proyectos.store') }}" novalidate>
            ...
            <div class="mb-5">
                ...
                <div x-show="tienesMacro" class="grid grid-cols-1 sm:grid-cols-2 gap-4" style="display: none;">
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Código del macroproyecto <span class="text-red-500">*</span></label>
                        <input type="text" name="codigo_macro" value="{{ old('codigo_macro') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre_macro" value="{{ old('nombre_macro') }}"

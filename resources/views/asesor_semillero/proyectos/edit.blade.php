                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="tipo_financiacion" class="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:border-[#39A900] focus:ring-2 focus:ring-[#39A900]/10 transition-all">
                            ...
                            <option value="capacidad_instalada" {{ old('tipo_financiacion', $proyecto->tipo_financiacion) === 'capacidad_instalada' ? 'selected' : '' }}>Capacidad instalada</option>
                            <option value="financiado" {{ old('tipo_financiacion', $proyecto->tipo_financiacion) === 'financiado' ? 'selected' : '' }}>Financiado</option>
                            <option value="con_alianza" {{ old('tipo_financiacion', $proyecto->tipo_financiacion) === 'con_alianza' ? 'selected' : '' }}>Con alianza</option>
                        </select>
                    </div>
                </div>
            </div>

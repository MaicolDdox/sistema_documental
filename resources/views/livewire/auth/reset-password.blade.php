        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation"
                       placeholder="••••••••"
                       class="w-full border border-slate-200 rounded-lg px-3.5 py-2.5
                              text-sm text-slate-800 focus:border-[#39A900] focus:ring-2 focus:ring-[#39A900]/10 transition-all" required>
            ...
            <button type="submit"
                    class="btn-sgd w-full text-white font-semibold py-2.5 px-4
                           rounded-lg text-sm cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#39A900]">

...
/**
 * Un co_investigador_sdi puede estar vinculado a varios proyectos, por eso
...
class ProyectoController extends Controller
{
    ...
    public function show(Project $proyecto): View
    {
        ...
        return view('co_investigador_sdi.proyectos.show', compact('proyecto'));
    }
    ...
    public function storeEvidencia(Request $request, Project $proyecto): RedirectResponse
    {
        ...
        return redirect()->route('co-investigador-sdi.proyectos.show', $proyecto)
    ...
    public function destroyEvidencia(ProjectEvidence $evidencia): RedirectResponse
    {
        ...
        return redirect()->route('co-investigador-sdi.proyectos.show', $evidencia->project_id)

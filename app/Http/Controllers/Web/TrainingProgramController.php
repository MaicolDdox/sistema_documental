...
class TrainingProgramController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $query = TrainingProgram::with(['trainingProgramType'])
        ...
        $types = TrainingProgramType::where('training_center_id', Auth::user()->training_center_id)->orderBy('nombre')->get();
    ...
    public function store(StoreTrainingProgramRequest $request): RedirectResponse
    {
        ...
        $type = TrainingProgramType::firstOrCreate(
            ['nombre' => trim($request->input('tipo')), 'training_center_id' => $centerId],
            ['descripcion' => '']
        );
        $data = $request->validated();
        unset($data['tipo']);
        $data['training_program_type_id'] = $type->id;
        $data['training_center_id'] = $centerId;
    ...
    public function edit(TrainingProgram $training_program): View
    {
        ...
        $this->checkCentroFormacion($training_program);
    ...
    private function checkCentroFormacion(TrainingProgram $item): void
    {

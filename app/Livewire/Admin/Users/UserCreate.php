...
class UserCreate extends Component
{
    ...
    public function mount(): void
    {
        ...
        if (RoleAssignmentMatrix::assignableRolesFor($auth) === []) {
            abort(403);
        }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.users.user-create', [
            ...
            'roles' => \Spatie\Permission\Models\Role::whereIn('name', RoleAssignmentMatrix::assignableRolesFor($auth))->orderBy('name')->get(),

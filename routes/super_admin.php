...
Route::middleware(['auth', 'ensure.active', 'role:super_administrador', 'active_role:super_administrador'])
    ->prefix('super-admin')
    ->name('super-admin.')
    ->group(function () {
        ...
        Route::get('/administradores/{id}/editar', [AdminUsuarioController::class, 'edit'])->name('administradores.edit');
        Route::put('/administradores/{id}', [AdminUsuarioController::class, 'update'])->name('administradores.update');
        ...
        Route::get('/usuarios-sistema/{id}/editar', [UsuarioSistemaController::class, 'edit'])->name('usuarios-sistema.edit');
        Route::put('/usuarios-sistema/{id}', [UsuarioSistemaController::class, 'update'])->name('usuarios-sistema.update');

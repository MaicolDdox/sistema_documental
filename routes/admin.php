...
Route::middleware(['auth', 'role:administrador_sistema|director_investigacion'])
    ->prefix('admin')
    ->name('admin.')
    ->group(function () {
        ...
        Route::middleware('role:administrador_sistema|director_investigacion')->group(function () {

...
namespace Tests\Feature\CoinvestigadorSdi;
...
class DashboardControllerTest extends TestCase
{
    ...
    private function crearCoinvestigadorVinculado(): array
    {
        ...
        // Reforma GDI/SDI: co_investigador_sdi SÍ lleva training_center_id
        // (a diferencia del co_investigador original, ya eliminado).
    ...
    public function test_reporte_descargar_no_truena(): void
    {
        ...
        $response = $this->actingAs($coinvestigador)->get(route('co-investigador-sdi.reporte.descargar'));

        $response->assertStatus(200);
    }

    public function test_role_module_links_apunta_al_dashboard_de_coinvestigador_sdi(): void
    {
        [$coinvestigador] = $this->crearCoinvestigadorVinculado();
    ...
    public function test_otro_rol_no_puede_entrar_al_modulo_coinvestigador_sdi(): void
    {
        ...
        $response = $this->actingAs($otro)->get(route('co-investigador-sdi.dashboard'));
